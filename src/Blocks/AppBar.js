...
const MaterialUISwitch = styled(Switch)(({ theme }) => ({
  ...
  '& .MuiSwitch-switchBase': {
    ...
    '&.Mui-checked': {
      ...
      '& + .MuiSwitch-track': {
        opacity: 1,
        backgroundColor: theme.palette.mode === 'dark' ? '#8796A5' : '#333',
      },
    },
  },
  '& .MuiSwitch-thumb': {
...
export default function ButtonAppBar() {
  const {mode, toggleLightColorMode,toggleDarkColorMode}  = useThemeContext();
      ...
      <AppBar position="static" sx ={{backgroundColor : (theme) => theme.palette.primary.main}}>
        <Toolbar>
          ...
          <FormControlLabel
            ...
            onClick={active ? toggleLightColorMode : toggleDarkColorMode }
